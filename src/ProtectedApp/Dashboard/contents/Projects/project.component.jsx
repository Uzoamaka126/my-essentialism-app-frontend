...
export function EditProjectText({
  name,
  onSubmit,
  projectId,
  value_id,
...
export function ProjectsComponent({
  ...
  function handleFetchAllProjects() {
    const payload = {
      userId: user?.id ? user?.id : userInfoIdLS,
    };
    fetchUserProjects(payload);
  }
  ...
  return (
    <Box>
      <Box>
        ...
        {fetchProjectsState === "failed" && !projects.length ? (
          <Flex
            marginTop="4rem"
            maxWidth="500px"
            marginRight="auto"
